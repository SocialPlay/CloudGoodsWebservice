...
namespace CloudGoods.Services.Webservice
{
    public class WebAPICallObjectCreator : CallObjectCreator
    {
        ...
        public WWW CreateSteamPremiumPurchaseCall(string SteamUserId, string bundleId)
        {
            return GenerateWWWCall("SteamPremiumCurrencyPurchase", GetParameter("SteamUserId", SteamUserId), GetParameter("bundleId", bundleId));
        }


        public WWW CreatSteamOrderConfirmationCall(SteamOrderConfirmationRequest request)
        {
